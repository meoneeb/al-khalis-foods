...
- Product images: `/public/images/products/` (match real filenames, often `{id}.webp`); missing files fall back to `placeholders` in `src/data/site.json` (e.g. product-package.webp).
- **Component layout:**
